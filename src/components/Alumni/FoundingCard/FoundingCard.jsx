        ...
        <motion.div {...HeadAnimation("up", 0.1)} >
            <div className={styles.foundingCard}>
                <ReactCardFlip isFlipped={isFlipped} flipDirection="horizontal">
                    <div className={styles.front} key="front" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                    ...
                    <div className={styles.back} key="back" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
